...
(if (true? inner-column)
  ...
  (defn column-offset [column] (cond
  (= column 2) [0 2.82 -4.5]
  (>= column 4) [1.5 -22 5.64]            ; original [0 -5.8 5.64]
  :else [0 0 0]))
  )
...
(if (true? innercolumn)
  (defn plate-width [column] (cond
    (= column 4) (+ base-plate-width 1)
    :else base-plate-width))
  (defn plate-width [column] (cond
    (= column 3) (+ base-plate-width 1)
    :else base-plate-width)))
...
(def thumb
  (union
   (thumb-1x-layout (rotate (/ π 2) [0 0 0] (single-plate 0)))
   (thumb-tr-place (rotate (/ π 2) [0 0 1] (single-plate 0)))
   (thumb-tr-place larger-plate)
   (thumb-tl-place (rotate (/ π 2) [0 0 1] (single-plate 0)))
...
(def minithumb
  (union
   (minithumb-1x-layout (single-plate 0))
   (minithumb-15x-layout (single-plate 0))))
...
(def newthumb
  (union
   (newthumb-1x-layout (single-plate 0))
   (newthumb-15x-layout larger-plate-half)
   (newthumb-15x-layout (single-plate 0))))
...
(def new-thumb-wall
  (union
   ...
   (wall-brace newthumb-bl-place -0.3  1 web-post-tr newthumb-bl-place  0  1 web-post-tl)
   (wall-brace newthumb-br-place -1  0 web-post-tl newthumb-br-place -1  0 web-post-bl)
   (wall-brace newthumb-bl-place -1  0 web-post-tl newthumb-bl-place -1  0 web-post-bl)
   ; newthumb corners
   (wall-brace newthumb-br-place -1  0 web-post-bl newthumb-br-place  0 -1 web-post-bl)
   (wall-brace newthumb-bl-place -1  0 web-post-tl newthumb-bl-place  0  1 web-post-tl)
   ; newthumb tweeners
   ...
   (bottom-hull
    ...
    (newthumb-bl-place (translate (wall-locate2 -0.3 1) web-post-tr))
    (newthumb-bl-place (translate (wall-locate3 -0.3 1) web-post-tr)))
   (hull
    (left-key-place (- cornerrow innercol-offset) -1 (translate (wall-locate2 -1 0) web-post))
    (left-key-place (- cornerrow innercol-offset) -1 (translate (wall-locate3 -1 0) web-post))
    (newthumb-bl-place (translate (wall-locate2 -0.3 1) web-post-tr))
   ...
   (hull
    (newthumb-bl-place web-post-tr)
    (newthumb-bl-place (translate (wall-locate1 -0.3 1) web-post-tr))
    (newthumb-bl-place (translate (wall-locate2 -0.3 1) web-post-tr))
    (newthumb-bl-place (translate (wall-locate3 -0.3 1) web-post-tr))
    (newthumb-ml-place thumb-post-tl))
...
(spit "things/right-switchPlate.scad"
      (write-scad model-right))

(spit "things/left-swtichPlate.scad"
